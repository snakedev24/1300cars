class CancelRequestModel {
  ...
  CancelRequestModel({this.statusCode, this.data});

  CancelRequestModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['status_code'];
    data = json['data'] != null ? new CancelRequestData.fromJson(json['data']) : null;
  }
...
class  CancelRequestData {
  ...
  CancelRequestData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
